...
class RidesControllerTest < ActionController::TestCase
  ...
  test "should create ride" do
    assert_difference('Ride.count') do
      post :create, ride: { date: @ride.date, from: @ride.from, time: @ride.time, to: @ride.to }
    end
  ...
  test "should update ride" do
    patch :update, id: @ride, ride: { date: @ride.date, from: @ride.from, time: @ride.time, to: @ride.to }
    assert_redirected_to ride_path(assigns(:ride))
  end
